   ...
   <div class="bar theme-d2 left-align">
    ...
    <div class="dropdown-hover hide-small">
      ...
      <div class="dropdown-content card-4 bar-block">
        <button onclick="random_bg_color()" class = "bar-item button hover-accent" >Random</button>
        <button onclick="defaultTheme()" class = "bar-item button hover-accent" >Default</button>
        <button onclick="setRemoteTheme()" class="bar-item button hover-accent" >Save</button>
      </div>
    </div>
    <!--Fun Section-->
    <div class="dropdown-hover hide-small">
